...
import com.instantmusic.appmovil.podcast.PodcastSongs;
...
public class PodcastSongs extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                clearMediaPlayer();
                play.setImageDrawable(ContextCompat.getDrawable(PodcastSongs.this, android.R.drawable.ic_media_play));
                isPaused = false;
                isPlaying = false;
                PodcastSongs.this.seekBar.setProgress(0);
            }
        });
        ...
        loop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if ( mediaPlayer != null ) {
                    if ( isLooped ) {
                        loop.setImageDrawable(ContextCompat.getDrawable(PodcastSongs.this, R.drawable.repeat));
                        mediaPlayer.setLooping(false);
                        isLooped = false;
                    }
                    else {
                        loop.setImageDrawable(ContextCompat.getDrawable(PodcastSongs.this, R.drawable.repeat2));
        ...
        shuffle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if ( isShuffled ) {
                    shuffle.setImageDrawable(ContextCompat.getDrawable(PodcastSongs.this, R.drawable.shuffle2));
                    isShuffled = false;
                }
                else {
                    shuffle.setImageDrawable(ContextCompat.getDrawable(PodcastSongs.this, R.drawable.shufflewhite));
                    isShuffled = true;
                }
            }
        });
    ...
    public void playSong() {
        ...
        if (!isPlaying && !isPaused) {
            try {
                ...
                play.setImageDrawable(ContextCompat.getDrawable(PodcastSongs.this, android.R.drawable.ic_media_pause));
