...
import com.instantmusic.appmovil.adapter.Model;
...
public class HorizontalAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.myplaylists_row, null, true);

            holder.tvname = (TextView) convertView.findViewById(R.id.text1);
            holder.iv = convertView.findViewById(R.id.text2);
        ...
        holder.iv.setText(imageModelArrayList.get(position).getImage_drawable());//setImageResource(imageModelArrayList.get(position).getImage_drawable());
